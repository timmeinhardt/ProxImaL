...
class patch_BM3D(ProxFn):
    ...
    def __init__(self, lin_op, sigma=0.04,
                 templateWindowSizeBM3D=3, searchWindowSizeBM3D=11, **kwargs):
        ...
        self.sigma = sigma
        self.templateWindowSizeBM3D = templateWindowSizeBM3D
        self.searchWindowSizeBM3D = searchWindowSizeBM3D
    ...
    def _prox(self, rho, v, *args, **kwargs):
        ...
        dst = np.array(pybm3d.bm3d.bm3d(v.astype(np.float32), self.sigma))
    ...
    def get_data(self):
        ...
        list
        """
        return [self.sigma, self.templateWindowSizeBM3D, self.searchWindowSizeBM3D]
